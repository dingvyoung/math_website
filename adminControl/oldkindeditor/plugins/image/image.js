	...
	self.plugin.image = {
		edit : function() {
			var html = [
				...
				'<img class="ke-refresh-btn" src="../../../../kindeditor/plugins/image/' + imgPath + 'refresh.gif" width="16" height="16" alt="" style="cursor:pointer;" />',
				'</div>',
				//align
				'<div class="ke-dialog-row">',
				'<label style="width:60px;">' + lang.align + '</label>',
				'<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /> <img name="defaultImg" src="../../../../kindeditor/plugins/image/' + imgPath + 'align_top.gif" width="23" height="25" alt="" />',
				' <input type="radio" name="align" class="ke-inline-block" value="left" /> <img name="leftImg" src="../../../../kindeditor/plugins/image/' + imgPath + 'align_left.gif" width="23" height="25" alt="" />',
				' <input type="radio" name="align" class="ke-inline-block" value="right" /> <img name="rightImg" src="../../../../kindeditor/plugins/image/' + imgPath + 'align_right.gif" width="23" height="25" alt="" />',
				'</div>',
				//title
				'<div class="ke-dialog-row">',
			...
			refreshBtn.click(function(e) {
				var tempImg = K('<img src="../../../../kindeditor/plugins/image/' + urlBox.val() + '" />', self.edit.doc).css({
						position : 'absolute',
						visibility : 'hidden',
						top : 0,
						left : '1000px'
