...
<link type="text/css" rel="stylesheet" href="acss/updatelist.css" />
<title>更新新闻</title>
</head>
...
<?php include('aULeft.php'); ?>
    ...
    <?php
		...
		{?>
            ...
            <a  style="color:#F3C;" href = "javascript:location.href='update.php?sortid=<?php echo $sort_id;?>&articleid=<?php echo $pagerow['articleid'];?>';">更新</a><br /><br />
		<?php
        }							
	?><br  />
    <strong>
    	本页显示第<b><?php echo ($num ? ($count+1) : 0) ;?></b>--<b><?php echo min($count+$pageSize,$num); ?></b>条记录，共<?php echo $num; ?>条记录。<a href="updatelist.php?sortid=<?php echo $sort_id;?>&page=<?php echo $firstPage;?>">首页</a>&nbsp;<a href="updatelist.php?sortid=<?php echo $sort_id;?>&page=<?php echo $prePage?>">上一页</a>&nbsp;<a href="updatelist.php?sortid=<?php echo $sort_id;?>&page=<?php echo $nextPage; ?>">下一页</a>&nbsp;<a href="updatelist.php?sortid=<?php echo $sort_id;?>&page=<?php echo $lastPage; ?>">尾页</a>
    </strong>
    </div>
</div>
<?php
